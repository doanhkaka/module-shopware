...
class Shopware_Plugins_Frontend_Paymentwall_Bootstrap extends Shopware_Components_Plugin_Bootstrap
{
    ...
    {
        try {
            $elvPayment = $this->Payments()->findOneBy(array('name' => 'pwlocal'));
    ...
    private function _createForm()
    {
        try {
            $form = $this->Form();
            $form->setElement('text', 'projectKey', array('label' => 'Project key', 'required' => true, 'position' => 0));
            $form->setElement('text', 'secretKey', array('label' => 'Secret key', 'required' => true, 'position' => 10));
            $form->setElement('text', 'publicKey', array('label' => 'Public key', 'required' => true, 'position' => 20));
            $form->setElement('text', 'privateKey', array('label' => 'Private key', 'required' => true, 'position' => 30));
            $form->setElement('text', 'widgetCode', array('label' => 'Widget code', 'required' => true, 'position' => 40));
